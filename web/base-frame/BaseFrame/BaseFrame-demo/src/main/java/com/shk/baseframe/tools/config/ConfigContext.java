...
public class ConfigContext {
	...
	public static final String FORDER_LIST_KEY = "FORDER_LIST_KEY";
	...
	public static String RENAME_TO_COMPANY = "eduo";
	public static String RENAME_BY_APP1 = "baseframe";
	public static String RENAME_TO_APP1 = "bugmanager";
